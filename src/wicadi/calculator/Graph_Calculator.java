...
public class Graph_Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("WiCaDi - Graph Calculator");
        ...
        getContentPane().add(btn7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 64, 57));
        ...
        getContentPane().add(btn9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 250, 64, 57));
        ...
        getContentPane().add(btn8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 64, 57));
        ...
        getContentPane().add(btnPercentage, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 64, 57));
        ...
        getContentPane().add(btnMultiply, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 310, 64, 57));
        ...
        getContentPane().add(btn6, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 64, 57));
        ...
        getContentPane().add(btn5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 64, 57));
        ...
        getContentPane().add(btn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 64, 57));
        ...
        getContentPane().add(btnMinus, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 370, 64, 57));
        ...
        getContentPane().add(btn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 370, 64, 57));
        ...
        getContentPane().add(btn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 370, 64, 57));
        ...
        getContentPane().add(btn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 64, 57));
        ...
        getContentPane().add(btnEqual, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 430, 64, 57));

        btnGraph.setBackground(new java.awt.Color(0, 102, 102));
        btnGraph.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        btnGraph.setForeground(new java.awt.Color(255, 255, 255));
        btnGraph.setText("Graph");
        btnGraph.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        getContentPane().add(btnGraph, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 490, 140, 50));
        ...
        getContentPane().add(btnDecimal, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 430, 64, 57));
        ...
        getContentPane().add(btn0, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 430, 64, 60));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 64, 57));
        ...
        getContentPane().add(btnBackSpace, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 64, 57));
        ...
        getContentPane().add(btnNegative, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 190, 64, 57));
        ...
        getContentPane().add(btnSin, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 190, 77, 57));
        ...
        getContentPane().add(btnCos, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 250, 77, 57));
        ...
        getContentPane().add(btnTan, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 310, 77, 57));
        ...
        getContentPane().add(btnCubeRoot, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 430, 77, 57));
        ...
        getContentPane().add(btnSqrt, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 370, 77, 57));
        ...
        getContentPane().add(btnLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, 77, 57));
        ...
        getContentPane().add(btnXpow2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 370, 77, 57));
        ...
        getContentPane().add(btnFraction, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 310, 77, 57));
        ...
        btnIntergration.setEnabled(false);
        btnIntergration.setFocusPainted(false);
        getContentPane().add(btnIntergration, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 490, 160, 50));

        btnArea.setBackground(new java.awt.Color(0, 102, 102));
        ...
        btnArea.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        getContentPane().add(btnArea, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 490, 130, 50));
        ...
        getContentPane().add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, 77, 57));

        txtDisplay.setEditable(false);
        txtDisplay.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        txtDisplay.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtDisplay.setEnabled(false);
        getContentPane().add(txtDisplay, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 450, 50));
        ...
        getContentPane().add(btnRead, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, 77, 57));
        ...
        getContentPane().add(btnFCal, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 64, 57));

        btnVariable_X.setBackground(new java.awt.Color(51, 0, 255));
        btnVariable_X.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        btnVariable_X.setEnabled(false);
        ...
        getContentPane().add(btnVariable_X, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 64, 57));

        btnVariable_Y.setBackground(new java.awt.Color(51, 0, 255));
        btnVariable_Y.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        btnVariable_Y.setEnabled(false);
        ...
        getContentPane().add(btnVariable_Y, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, 64, 57));

        btnVariable_Z.setBackground(new java.awt.Color(51, 0, 255));
        btnVariable_Z.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        btnVariable_Z.setEnabled(false);
        ...
        getContentPane().add(btnVariable_Z, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 130, 64, 57));
        ...
        getContentPane().add(btnOpenParen, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 130, 77, 57));
        ...
        getContentPane().add(btnCloseParen, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, 77, 57));
        ...
        getContentPane().add(btnPi, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 250, 77, 57));
        ...
        getContentPane().add(Xpow3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 430, 77, 57));

        btnDivide1.setBackground(new java.awt.Color(51, 0, 255));
        btnDivide1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        btnDivide1.setForeground(new java.awt.Color(255, 255, 255));
        btnDivide1.setText("/");
        btnDivide1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnDivide1.setEnabled(false);
        btnDivide1.setFocusPainted(false);
        btnDivide1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDivide1ActionPerformed(evt);
            }
        });
        getContentPane().add(btnDivide1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 64, 57));

        btnAdd1.setBackground(new java.awt.Color(51, 0, 255));
        ...
        getContentPane().add(btnAdd1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 430, 64, 57));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Capture.JPG"))); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 470, 560));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 0, 460, 560));
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Graph_Calculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Graph_Calculator().setVisible(true);
            }
        });
    }
